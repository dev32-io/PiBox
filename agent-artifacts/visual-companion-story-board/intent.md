# Intent: Visual Companion Story Board
...
- Story Board loading, Refresh, Architecture regression, responsive behavior, and accessibility are verifiable through a shared-backend fixture server and browser automation
...
- The browser E2E surface must be launchable deterministically without requiring another interactive Pi/TUI session
