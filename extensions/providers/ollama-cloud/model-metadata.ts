 ...
 */
export const OLLAMA_CLOUD_THINKING_LEVEL_MAP = {
	off: "none",
	minimal: null,
	low: "low",
	medium: "medium",
	...
	xhigh: null,
	max: "max",
} as const satisfies NonNullable<DiscoveredModelMetadata["thinkingLevelMap"]>;
...
export const OLLAMA_CLOUD_MODEL_METADATA: Readonly<Record<string, DiscoveredModelMetadata>> = {
	...
	"glm-5.1": { contextWindow: 202_752, reasoning: true, images: false },
	"mistral-large-3:675b": { contextWindow: 262_144, reasoning: false, images: true },
	"gpt-oss:20b": { contextWindow: 131_072, reasoning: true, thinkingLevelMap: GPT_OSS_THINKING_LEVEL_MAP, images: false },
	"gpt-oss:120b": { contextWindow: 131_072, reasoning: true, thinkingLevelMap: GPT_OSS_THINKING_LEVEL_MAP, images: false },
	...
	"deepseek-v4-pro": { contextWindow: 1_048_576, reasoning: true, images: false },
	"deepseek-v4-pro:0813": { contextWindow: 1_048_576, reasoning: true, images: false },
};
