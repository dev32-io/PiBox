...
export const BUILT_IN_PROMPT_SURFACES: PromptSurface[] = [
	...
	{ id: "planned-evaluator", category: "dynamic", source: "extensions/harness/index.ts#launchManagedEvaluation", completion: "evaluation_complete" },
	{ id: "typed-explorer", category: "dynamic", source: "extensions/harness/index.ts#exploration_launch", completion: "exploration_complete" },
	{ id: "task-protocol-nudge", category: "protocol", source: "extensions/harness/supervisor.ts#taskPrompt", completion: "task_complete" },
	{ id: "evaluation-protocol-nudge", category: "protocol", source: "extensions/harness/index.ts#launchManagedEvaluation", completion: "evaluation_complete" },
	{ id: "exploration-protocol-nudge", category: "protocol", source: "extensions/harness/index.ts#exploration_launch", completion: "exploration_complete" },
	{ id: "missing-role-fallback", category: "fallback", source: "extensions/workflows/direct-agent.ts#runDirectAgent", completion: "none" },
	...
	{ id: "explorer-tool-pointers", category: "tool-pointer", source: "extensions/harness/exploration-capabilities.ts#registerExplorationCapabilities", completion: "exploration_complete" },
];
