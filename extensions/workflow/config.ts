...
export const DEFAULT_HARNESS_CONFIG: HarnessConfig = {
	...
	roles: {
		...
		implementer: { workspace: "worktree", canDelegate: false, completionSchema: "implementer-v1", tier: "medium", deliberation: "standard" },
		...
		"test-implementer": { workspace: "worktree", canDelegate: false, completionSchema: "implementer-v1", tier: "medium", deliberation: "standard" },
		"e2e-tester": { workspace: "repository", canDelegate: false, tier: "medium", deliberation: "standard" },
		"repair-implementer": { workspace: "worktree", canDelegate: false, tier: "high", deliberation: "standard" },
	},
