...
export const BUILT_IN_PROMPT_SURFACES: PromptSurface[] = [
	...
	...[
		"explorer", "plan-critic", "implementer", "code-reviewer", "e2e-tester", "repair-implementer",
	].map((id): PromptSurface => ({ id, category: "agent", source: `agent-definitions/${id}.md`, completion: "none" })),
	{ id: "supervised-task", category: "dynamic", source: "prompt/managed-task.md", completion: "none" },
	...
	{ id: "workflow-task-agent", category: "protocol", source: "prompt/workflow-task-agent.md", completion: "task_complete" },
	{ id: "workflow-review-agent", category: "protocol", source: "prompt/workflow-review-agent.md", completion: "evaluation_complete" },
	{ id: "workflow-explorer-agent", category: "protocol", source: "prompt/workflow-explorer-agent.md", completion: "exploration_complete" },
	...
	{ id: "planned-evaluator", category: "dynamic", source: "prompt/managed-evaluation.md", completion: "none" },
	{ id: "typed-explorer", category: "dynamic", source: "prompt/managed-exploration.md", completion: "none" },
