...
export interface PromptSurface {
	...
	source: string;
	completion: "none" | "task_complete" | "evaluation_complete" | "workflow_transition:submit" | "work_item_complete";
}
...
export const BUILT_IN_PROMPT_SURFACES: PromptSurface[] = [
	...
	...[
		"product-discussion", "shape-story", "plan-delivery", "workflow-run", "distill",
	...
	...[
		"general-purpose", "explorer", "knowledge-distiller", "plan-critic", "implementer", "code-reviewer", "e2e-tester", "repair-implementer",
