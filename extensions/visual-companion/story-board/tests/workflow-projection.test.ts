...
test("current workflow projection aggregates operations and exposes only safe runtime fields", async (t) => {
	...
	assert.deepEqual(workspace.workflow.metrics, {
		workflowMs: 15, categories: { implementation: 5, integration: 4, verification: 3, review: 2, e2e: 1 }, incompleteIntervals: 2, incompleteCategories: ["review"],
		activeCategory: "implementation", activeSince: "2025-01-02T00:00:00.000Z", activeStageId: "foundation",
		stageBreakdown: { foundation: { workflowMs: 14, categories: { implementation: 5, integration: 4, verification: 3, review: 2, e2e: 0 }, incompleteIntervals: 1, incompleteCategories: ["review"], activeCategory: "implementation", activeSince: "2025-01-02T00:00:00.000Z" } },
	});
	...
	assert.deepEqual(stage.timing, { workflowMs: 14, categories: { implementation: 5, integration: 4, verification: 3, review: 2, e2e: 0 }, incompleteIntervals: 1, incompleteCategories: ["review"], activeCategory: "implementation", activeSince: "2025-01-02T00:00:00.000Z" });
